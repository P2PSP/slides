...
%{{{
  ...
  \vbox{
    ...
    \HCode{<div style="text-align:center;">
      <img width=800 src="http://slides.p2psp.org/2014-11-Jornada_Contenidos_Digitales_UAL/FIGs/thanks.svg" align="top"/>
      </div>
    }
    \fi
  }
...
\HCode{
  <div style="text-align:center;">
    <img height="600" src="http://slides.p2psp.org/2014-11-Jornada_Contenidos_Digitales_UAL/FIGs/DVB.svg" />
  </div>
}
\fi
...
\HCode{
  <div style="text-align:center;">
    <img height="500" src="http://slides.p2psp.org/2014-11-Jornada_Contenidos_Digitales_UAL/FIGs/world-internet.svg" />
  </div>
}
\fi
...
\HCode{
  <div style="text-align:center;">
    <img height="600" src="http://slides.p2psp.org/2014-11-Jornada_Contenidos_Digitales_UAL/FIGs/spain-IPVoD.svg" />
  </div>
}
\fi
...
\ifx \HCode\Undfef
%\begin{center}
%  \includegraphics[width=1.0\textwidth]{http://slides.p2psp.org/2014-11-Jornada_Contenidos_Digitales_UAL/FIGs/spain-IPTV-Hub}
%\end{center}
\else
\HCode{
  <div style="text-align:center;">
    <img height="600" src="http://slides.p2psp.org/2014-11-Jornada_Contenidos_Digitales_UAL/FIGs/spain-IPTV-Hub.svg" />
  </div>
}
\fi
...
\HCode{
  <div style="text-align:center;">
    <img height="600" src="http://slides.p2psp.org/2014-11-Jornada_Contenidos_Digitales_UAL/FIGs/unicast-server.svg" />
  </div>
}
\fi
% <object
...
\HCode{
  <div style="text-align:center;">
    <img height="600" src="http://slides.p2psp.org/2014-11-Jornada_Contenidos_Digitales_UAL/FIGs/multicast-server.svg" />
  </div>
}
\fi
...
\HCode{
  <div style="text-align:center;">
    <img height="500" src="http://slides.p2psp.org/2014-11-Jornada_Contenidos_Digitales_UAL/FIGs/unicast-splitter.svg" />
  </div>
}
\fi
...
\HCode{
  <div style="text-align:center;">
    <img height="600" src="http://slides.p2psp.org/2014-11-Jornada_Contenidos_Digitales_UAL/FIGs/spain-IPTV-P2P.svg" />
  </div>
}
\fi
...
\HCode{
  <div style="text-align:center;">
    <img height="600" src="http://slides.p2psp.org/2014-11-Jornada_Contenidos_Digitales_UAL/FIGs/multicast-splitter.svg" />
  </div>
}
\fi
...
\HCode{
  <div style="text-align:center;">
    <img height="200" src="http://slides.p2psp.org/2014-11-Jornada_Contenidos_Digitales_UAL/FIGs/ACS.svg" />
  </div>
}
\fi
...
\HCode{
  <div style="text-align:center;">
    <img height="200" src="http://slides.p2psp.org/2014-11-Jornada_Contenidos_Digitales_UAL/FIGs/LRS.svg" />
  </div>
}
\fi
...
\HCode{
  <div style="text-align:center;">
    <img height="250" src="http://slides.p2psp.org/2014-11-Jornada_Contenidos_Digitales_UAL/FIGs/EMS.svg" />
  </div>
}
\fi
...
\HCode{
  <div style="text-align:center;">
    <img height="300" src="http://slides.p2psp.org/2014-11-Jornada_Contenidos_Digitales_UAL/FIGs/3d-example.svg" />
  </div>
}
\fi
\item
