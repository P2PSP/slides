...
sleep 1
xterm -e "python ~/P2PSP/simulator/src/monitor_video.py --splitter_addr 127.0.0.1 --splitter_port 8001" &
sleep 1
cvlc http://localhost:9999 & # Monitor's player
sleep 1
xterm -e "python ~/P2PSP/simulator/src/peer_video.py --splitter_addr 127.0.0.1 --splitter_port 8001 --player_port 10000" &
sleep 1
